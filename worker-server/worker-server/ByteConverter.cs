...
namespace worker_server
{
    public static class ByteConverter
    {
        ...
        {
            var buffer = new byte[matrix.GetLength(0) * matrix.GetLength(1) * Marshal.SizeOf(typeof(int))];
        ...
        {
            var len = Math.Min(matrix.GetLength(0) * matrix.GetLength(1) * Marshal.SizeOf(typeof(int)),
                byteArray.Length);
